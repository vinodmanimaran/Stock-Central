 ...
 const message = `
  <html>
    ...
    <body>
      ...
      <p>We received a request to reset your password for your StockCentral account.</p>
      <p>Please use the URL below to reset your password. This link is valid for 30 minutes only.</p>
